...
export const adresSorgulamaModalData = {
  borclu_id: undefined, // tbd
  sorgu_tipi: undefined, // tbd
  MERNIS: {
    sonuc: {
      "Kimlik Bilgileri": {
...
export const bankaSorgulamaModalData = {
  ...
  Banka: {
    ...
    bankalar: [
      { no: "1", kurum: "TÜRKİYE HALK BANKASI A.Ş." },
      { no: "2", kurum: "TÜRKİYE VAKIFLAR BANKASI T.A.O." },
      { no: "3", kurum: "TÜRK EKONOMİ BANKASI A.Ş." },
      { no: "4", kurum: "AKBANK T.A.Ş." },
      { no: "5", kurum: "TÜRKİYE GARANTİ BANKASI A.Ş." },
      { no: "6", kurum: "TÜRKİYE İŞ BANKASI A.Ş." },
      { no: "7", kurum: "YAPI VE KREDİ BANKASI A.Ş." },
      { no: "8", kurum: "QNB BANK A.Ş." },
...
export const telefonSorgulamaModalData = {
  ...
  GSM: {
    ...
    "GSM Adres": [
      { Operatör: "Turkcell", adres: "VATAN MH. POLAT CD. NO:30 D:4 YEŞİLYURT \\KARABAĞLAR, İZMİR" },
      { Operatör: "Türk Telekom", adres: "9076 SK. NO:12 YEŞİLYURT KONAK" },
      { Operatör: "Turkcell", adres: "HACET MH. BERK SK. NO:5 \\ALANYA, ANTALYA" },
      { Operatör: "Turkcell", adres: "BOZYAKA MH. 3031 SK. NO:65 D:5 \\KARABAĞLAR, İZMİR" },
      { Operatör: "Turkcell", adres: "BOZYAKA MH. 3056 SK. NO:43 D:3 \\KARABAĞLAR, İZMİR" },
      { Operatör: "Türk Telekom", adres: "KARABAĞLAR-KARABAĞLAR" },
      { Operatör: "Vodafone", adres: "VATAN MAH. POLAT CADDESİ 9061. SOK. KARABAĞLAR, İZMİR" },
      { Operatör: "Vodafone", adres: "9076 SOK. NO:12 İZMİR TÜRKİYE , İZMİR" },
      { Operatör: "Turkcell", adres: "NO:6 DEREBAŞI KÖYÜ \\KİRAZ, İZMİR" },
      { Operatör: "Türk Telekom", adres: "KARABAĞLAR-KARABAĞLAR" },
      { Operatör: "Türk Telekom", adres: "KÜBRA SOK 66 34000 - . AVCILAR" },
      { Operatör: "Vodafone", adres: "VATAN MAH. POLAT CADDESİ 9061. SOK. KARABAĞLAR, İZMİR" },
    ],
  },
};
...
export const sgkHacizSorgulamaModalData = {
  ...
  "SGK Haciz": {
    sonuc: "SGK kaydı var.",
    "SGK kayit": [
      { no: "1", kurum: "GSS Sigortalısı (Gerçek)", islem: "" },
