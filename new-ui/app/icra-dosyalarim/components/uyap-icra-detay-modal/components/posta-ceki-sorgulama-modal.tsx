...
import { postaCekiSorgulamaModalData } from "@/app/icra-dosyalarim/components/uyap-icra-detay-modal/utils/sample-data"

// Convenience exports for backward compatibility
const postaCekiSorguSonucuData = postaCekiSorgulamaModalData["Posta Çeki"]
...
export default function PostaCekiSorgulamaModal({
  ...
  const postaCekiSorguSonucu = postaCekiSorguSonucuData
        ...
        <DialogHeader className="flex-shrink-0 p-6 pb-4 border-b border-gray-200">
          <DialogTitle className="text-xl font-bold text-gray-900 flex items-center justify-between">
            <div className="flex items-center gap-2">
              📮 Posta Çeki Sorgulama Sonuçları
              <Badge
          ...
          <DialogDescription className="sr-only">
            Borçlu kişinin posta çeki kayıtlarını UYAP üzerinden sorgulama sonuçları
          </DialogDescription>
          ...
          <Card>
            <CardHeader className="pb-4">
              <CardTitle className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                📊 Sorgu Sonucu
                <span className="text-sm font-normal text-green-700">✅ Posta çeki kaydı bulundu</span>
              </CardTitle>
            </CardHeader>
          </Card>
